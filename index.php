    ...
    <section id="brands">
        ...
        <div class="slider owl-carousel">
            ...
            while ($row_owlslider_picture_1 = mysqli_fetch_array($run_owlslider_1)) {
             ...
             <div class='img'>
                 <a href='productbrands.php?brand_name=$brand_name'><img src='./admin_panel/brands/brands_images/$image_source' alt=''></a>
             </div>
            <div class='content'>
                <div class='title'>
                $brand_name
        ...
        <div class="gallery">
            ...
            while ($row_category_picture = mysqli_fetch_array($run_gallery_image)) {
                ...
                echo "<div class='gallery__column'>
                        <a href='productcategory.php?category_name=$category_name' target='_blank' class='gallery__link'>
