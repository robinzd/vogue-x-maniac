...
<body>
    ...
    <div class="col-sm-8 col-md-9 col-xl-12">
        <div class="row">
            ...
            $get_product = "select * from products_details where product_category='$product_category'";
            ...
            while ($row = mysqli_fetch_array($run_product)) {
                ...
                $get_category_image = "select details_image from products_images where primary_image=1 and related_product=$product_id";

                $run_category_image = mysqli_query($conn,$get_category_image );

                $details_image = null;

                while ($row_category_image = mysqli_fetch_array($run_category_image)) {




                    $details_image = $row_category_image['details_image'];
                }
