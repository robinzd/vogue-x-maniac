...
<body>
    ...
    <div class="container mt-5 mb-5  d-none d-sm-block">
        ...
        <div class="text-left"><a href="./user_order_details.php"><i class="fa fa-arrow-left"></i></a></div><br>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody class="totals">
                                        ...
                                        if ($amount_paid == 250) {
                                            ...
                                            <td>
                                                <div class='text-right'>
                                                    <span class='font-weight-bold' id='balance'><strong>₹$balance_amount.00</strong></span>
                                                </div>
                                            </td>
                                        </tr>";
                                        } else {
                                            ...
                                            <td>
                                                <div class='text-right'>
                                                    <span class='font-weight-bold' id='full'><strong>₹$amount_paid</strong></span>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
