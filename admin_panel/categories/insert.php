...
if (isset($_POST['submit'])) {
	...
	if (!in_array($extension, $allowed_extensions)) {
		...
		$query = mysqli_query($conn, "insert into product_category(category_image,category_name) value ('$imgnewfile','$categorytitle')");
		if ($query) {
...
<body>
	<div class="signup-form">
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="title" placeholder="Enter Your category name" required="true">
			</div>
