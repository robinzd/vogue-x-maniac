...
$pic=$_GET['category_image'];
$ppicpath="categories_images"."/".$pic;
$sql=mysqli_query($conn,"delete from product_category where ID=$rid");
unlink($ppicpath);
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($conn,"select * from product_category");
$cnt=1;
...
<!--Fetch the Records -->
  ...
  <a href="read.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            ...
                            <a href="categories.php?delid=<?php echo ($row['ID']);?>&&category_image=<?php echo $row['category_image'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php 
$cnt=$cnt+1;
