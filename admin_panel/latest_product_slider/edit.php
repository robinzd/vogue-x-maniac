	...
	<div class="signup-form">
		<form method="POST">
			...
			?>
				...
				<div class="form-group">
					<input type="text" class="form-control" name="title" value="<?php echo $row['product_title']; ?>" required="true">
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="strikeoutprice" value="<?php echo $row['product_strikeout_price']; ?>" required="true">
				</div>
				<div class="form-group">
