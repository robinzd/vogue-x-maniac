...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		<h2>Fill Data</h2>
		<p class="hint-text">Insert Your Product.</p>
		...
		<div class="form-group">
        	<input type="text" class="form-control" name="title" placeholder="Enter Your product name"  required="true">
        </div>

		<div class="form-group">
        	<input type="text" class="form-control" name="strikeoutprice" placeholder="Enter Your product strikeout price"  required="true">
        </div>
