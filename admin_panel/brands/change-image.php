...
if (isset($_POST['submit'])) {
	...
	$brandimage = $_FILES["image_source"]["name"];
	$oldppic = $_POST['oldpic'];
	$oldprofilepic = "brands_images" . "/" . $oldppic;
	// get the image extension
	$extension = substr($brandimage, strlen($brandimage) - 4, strlen($brandimage));
	// allowed extensions
	...
	if (!in_array($extension, $allowed_extensions)) {
		...
		$query = mysqli_query($conn, "update owlslider_1 set image_source='$imgnewfile' where id='$uid' ");
		if ($query) {
			//Old pic
			unlink($oldprofilepic);
			echo "<script>alert('Brand Image updated successfully');</script>";
...
<head>
	...
	<title>Change brand Image</title>
...
<body>
	<div class="signup-form">
		<form method="POST" enctype="multipart/form-data">
			...
			?>
				<h2>Update Brand Image </h2>
				
				<input type="hidden" name="oldpic" value="<?php echo $row['image_source']; ?>">
