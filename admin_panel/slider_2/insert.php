...
$query=mysqli_query($conn, "insert into slider_2(slider2_name,slider2_image) value ('$slidername','$imgnewfile')");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="slidername" placeholder="Enter The slider name" required="true">
        </div>
