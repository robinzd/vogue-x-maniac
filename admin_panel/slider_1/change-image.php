...
if (isset($_POST['submit'])) {
	...
	$oldprofilepic = "slides_images" . "/" . $oldppic;
...
<body>
	<div class="signup-form">
		<form method="POST" enctype="multipart/form-data">
			...
			?>
				<h2>Update Slider1 Image</h2>
				
				<input type="hidden" name="oldpic" value="<?php echo $row['slider_image']; ?>">
				<div class="form-group">
					<img src="slides_images/<?php echo $row['slider_image']; ?>" width="120" height="120">
				</div>

				<div class="form-group">
					<input type="file" class="form-control" name="slider_image" required="true">
