				...
				<div class="col-md-4 d-flex">
		    		...
		    		<p class="mb-0 d-flex">
		    			...
		    			<a href="./admin_panel/slider_1.php" class="d-flex align-items-center justify-content-center"><span class="fa fa-sign-out"><i class="sr-only">Instagram</i></span></a>
		    			 <a href="./admin_panel/slider_1/index.php" class="d-flex align-items-center justify-content-center"><span class="fa fa-dribbble"><i class="sr-only">Dribbble</i></span></a>
		    		</p>
	        </div>
				</div>
			</div>
