			...
			<div class="row justify-content-between">
				...
				<div class="col-md-4 d-flex">
		    		...
		    		<p class="mb-0 d-flex">
		    			...
		    			<a href="./admin_panel/admin_panel.php" class="d-flex align-items-center justify-content-center"><span class="fa fa-sign-out"><i class="sr-only">Instagram</i></span></a>
		    			 <a href="./admin_panel/brands/brand.php" class="d-flex align-items-center justify-content-center"><span class="fa fa-dribbble"><i class="sr-only">Dribbble</i></span></a>
		    		</p>
	        </div>
				</div>
			</div>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
			                <a class="dropdown-item" href="#">Womens watches</a>
							<a class="dropdown-item" href="#">Mens Watches</a>
							<a class="dropdown-item" href="#">Shoes</a>
							<a class="dropdown-item" href="#">Airpods</a>
							<a class="dropdown-item" href="#">BT Speakers</a>
							<a class="dropdown-item" href="#">Smart Watches</a>
							<a class="dropdown-item" href="#">Travel Bags</a>
							<a class="dropdown-item" href="#">Womens Handbags</a>
              </div>
            </li>
