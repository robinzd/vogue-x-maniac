...
<body>
                ...
                <div class="card">
                    ...
                    `                            <span id="date"><?php echo $order_date; ?></span>
                        ...
                        if ($tracking_link == 'nothing') {
                            echo "<h3><strong>Tracking Link Appears Here After The Product Dispatch</strong></h3>";
                        } else {
                            echo "<h3><strong>Tracking Link</strong>:<a href='$tracking_link' class='link'>$tracking_link</a></h3>";
                        }
                        ?>
    ...
    <div class="container mt-5 mb-5 d-block d-sm-none" style="zoom:70%" id="mybill">
        ...
        <div class="text-left" id="backbutton"><a onclick="history.back()"><i class="fa fa-arrow-left"></i></a></div><br>
            ...
            <div class="col-md-8" id="orderbill">
                ...
                <div class="card">
                    ...
                    <div class="invoice p-5">
                        ...
                        if ($tracking_link == 'nothing') {
                            echo "<h3 class='heading3'><strong>Tracking Link Appears Here After The Product Dispatch</strong></h3>";
                        } else {
                            echo "<h3 class='heading3'><strong>Tracking Link</strong>:<a href='$tracking_link' class='link1'>$tracking_link</a></h3>";
                        }
                        ?>
