    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-4">
            <div class="payment-info">
                <div class="d-flex justify-content-between align-items-center"><span>Card details</span><img class="rounded" src="https://i.imgur.com/WU501C8.jpg" width="30"></div><span class="type d-block mt-3 mb-1">Card type</span><label class="radio">
               <input type="radio" name="card" value="payment" checked> <span><img id="payment" src="./payment_pics/2560px-MasterCard_Logo.svg-removebg-preview.png" /></span> </label>
                ...
                <label class="radio"> <input type="radio" name="card" value="payment"> <span><i id="payment" class="fa fa-cc-stripe" aria-hidden="true"></i></span> </label>
